...
if ( is_writable('.') | is_writable('thumbs') ) $caching = "Yes";
...
<div  class="<?php if($caching == "Yes") echo 'middle-yes'; else echo 'middle-no' ?>">
    <?php echo $caching; ?>
</div>
<div class="right">
    For caching to work, the album root must be writable, or contain a writable subdirectory named 'thumbs'.
</div>
<br />
